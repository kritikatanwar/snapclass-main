...
from src.database.db import get_all_students, create_student,get_student_subjects,get_student_attendance,unenroll_student_to_table
import time
...
def student_screen():
    ...
    if show_registration:
        ...
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name",placeholder="E.g. Kritika Tanwar")
            ...
            try:
                ...
                audio_data = st.audio_input( 'Record a short sentence like: I am present, My name is Kritika')
                ...
                if new_name:
                    ...
                    with st.spinner('Creating profile....'):
                        ...
                        if encodings:
                            ...
                            st.warning('Couldnt capture your facial features for recognition')
